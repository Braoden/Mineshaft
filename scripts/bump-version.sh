...
# =============================================================================
#
# This script handles version bumping for Excavation Site releases.
...
usage() {
    ...
    echo ""
    echo "Bump version across all Excavation Site components."
    echo ""
    echo "Arguments:"
...
Generated by scripts/bump-version.sh"
        ...
        if [ "$AUTO_PUSH" = true ]; then
            ...
            echo "Monitor: https://github.com/steveyegge/excavation/actions"
