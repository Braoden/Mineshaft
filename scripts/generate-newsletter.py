...
"""
Generate a weekly Mineshaft newsletter based on changelog, commits, and changes.
...
NEWSLETTER_PROMPT_TEMPLATE = """Generate a Mineshaft newsletter covering the period from {since_date} to {until_date}.
...
app = typer.Typer(help="Generate a weekly Mineshaft newsletter based on changelog and commits")
