...
|------|------|-------|-----------------|
| `supervisor-zombie.yaml` | Supervisor | 10 | Zombie session detection vs healthy/idle/crashed |
| `supervisor-plugin-gate.yaml` | Supervisor | 10 | Plugin cooldown/cron gate evaluation (mechanical) |
| `supervisor-dog-health.yaml` | Supervisor | 10 | Dog timeout matrix and pool spawn/retire decisions |
| `witness-stuck.yaml` | Witness | 12 | Stuck miner assessment: no-op → nudge → escalate |
...
| File | Role | Tests | What It Measures |
|------|------|-------|-----------------|
| `class-a-supervisor.yaml` | Supervisor | 3 | Zombie vs idle vs healthy from raw evidence |
...
- description: "What this test checks"
  vars:
    role: supervisor|witness|refinery|dog
    role_context: >
...
├── tests/
│   ├── supervisor-zombie.yaml         # 10 Class B tests
│   ├── supervisor-plugin-gate.yaml    # 10 Class B tests
│   ├── supervisor-dog-health.yaml     # 10 Class B tests
...
│   ├── class-a-supervisor.yaml        #  3 Class A tests
