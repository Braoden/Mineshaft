...
func TestAssigneeToWorktreePath_NewStructure(t *testing.T) {
	...
	// Create new-structure worktree: townRoot/testrig/miners/max/testrig/
	worktreePath := filepath.Join(townRoot, rigName, "miners", "max", rigName)
	...
	got := assigneeToWorktreePath(townRoot, "testrig/miners/max")
	if got != worktreePath {
...
func TestAssigneeToWorktreePath_OldStructure(t *testing.T) {
	...
	// Create old-structure worktree: townRoot/testrig/miners/max/
	worktreePath := filepath.Join(townRoot, rigName, "miners", "max")
	if err := os.MkdirAll(worktreePath, 0755); err != nil {
		t.Fatal(err)
	}
	// Create .git file (worktree indicator)
...
func TestAssigneeToWorktreePath_NoWorktree(t *testing.T) {
	...
	dirPath := filepath.Join(townRoot, "testrig", "miners", "max")
...
func TestCheckWorktreeState_CleanRepo(t *testing.T) {
	...
	checkWorktreeState(townRoot, "testrig/miners/max", result)
...
func TestCheckWorktreeState_NonexistentPath(t *testing.T) {
	...
	result := &StaleHookResult{}
	checkWorktreeState(townRoot, "testrig/miners/ghost", result)
