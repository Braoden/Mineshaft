...
// Supports miner format "rig/miners/name" and crew format "rig/crew/name".
func assigneeToWorktreePath(townRoot, assignee string) string {
	...
	if agentType != "miners" && agentType != "crew" {
		return ""
	}

	rigPath := filepath.Join(townRoot, rigName)

	// New structure: rig/miners/<name>/<rigname>/
