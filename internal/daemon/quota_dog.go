...
// runQuotaDog executes a quota rotation cycle by shelling out to `ms quota rotate`.
// The daemon is a thin ticker — `ms quota rotate` handles scanning for rate-limited
