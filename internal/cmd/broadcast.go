...
Examples:
  ms broadcast "Check your mail"
  ms broadcast --rig greenplace "New priority work available"
  ms broadcast --all "System maintenance in 5 minutes"
  ms broadcast --dry-run "Test message"`,
