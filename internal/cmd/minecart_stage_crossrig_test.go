...
// TestMinecartStage_CrossRigWaves is the regression test for hq-mtc.
//
...
// is correct.
func TestMinecartStage_CrossRigWaves(t *testing.T) {
...
`
	...
	// Drive collectTaskListBeads → buildMinecartDAG → computeWaves directly.
