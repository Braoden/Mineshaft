...
var mailHookCmd = &cobra.Command{
	Use:   "hook <mail-id>",
	Short: "Attach mail to your hook (alias for 'ms hook attach')",
	Long: `Attach a mail message to your hook.

This is an alias for 'ms hook attach <mail-id>'. It attaches the specified
...
Examples:
  ms mail hook msg-abc123                    # Attach mail to your hook
  ms mail hook msg-abc123 -s "Fix the bug"   # With subject for handoff
  ms mail hook msg-abc123 --force            # Replace existing incomplete work

Related commands:
  ms hook <bead>     # Attach any bead to your hook
  ms hook status     # Show what's on your hook
