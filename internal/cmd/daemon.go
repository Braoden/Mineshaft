...
var daemonCmd = &cobra.Command{
	...
	Short:   "Manage the Mineshaft daemon",
	RunE:    requireSubcommand,
	Long: `Manage the Mineshaft background daemon.
...
var daemonStopCmd = &cobra.Command{
	...
	Long: `Stop the running Mineshaft daemon.
...
var daemonStatusCmd = &cobra.Command{
	...
	Long: `Show the current status of the Mineshaft daemon.
...
var daemonEnableSupervisorCmd = &cobra.Command{
	...
	Long: `Configure external supervision for the Mineshaft daemon.
...
func runDaemonEnableSupervisor(cmd *cobra.Command, args []string) error {
	...
	if runtime.GOOS == "darwin" {
		fmt.Println("  launchctl unload ~/Library/LaunchAgents/com.mineshaft.daemon.plist")
	} else {
		fmt.Println("  systemctl --user stop mineshaft-daemon.service")
		fmt.Println("  systemctl --user disable mineshaft-daemon.service")
	}
	return nil
}
