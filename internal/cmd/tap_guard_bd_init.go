...
var tapGuardBdInitCmd = &cobra.Command{
	...
	Long: `Block beads initialization outside the Mineshaft HQ root.
...
Exit codes:
  0 - Operation allowed (in HQ root or not in Mineshaft context)
...
func runTapGuardBdInit(cmd *cobra.Command, args []string) error {
	...
	fmt.Fprintln(os.Stderr, "║  Mineshaft uses a centralized DB at the HQ root.                 ║")
