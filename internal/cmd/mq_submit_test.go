...
func TestVerifyMQSubmitPushedBranchRequiresRemoteBranch(t *testing.T) {
	...
	for _, want := range []string{"git push origin feature/pr-target", "ms done"} {
...
func TestValidateMoleculePrereqs(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			children: []*beads.Issue{
				{ID: "ms-mol.1", Title: "Load context", Status: "closed"},
				{ID: "ms-mol.2", Title: "Set up branch", Status: "closed"},
				{ID: "ms-mol.3", Title: "Implement", Status: "closed"},
				{ID: "ms-mol.4", Title: "Self-review", Status: "closed"},
				{ID: "ms-mol.5", Title: "Build check", Status: "closed"},
				{ID: "ms-mol.6", Title: "Commit changes", Status: "closed"},
				{ID: "ms-mol.7", Title: "Rebase verify", Status: "closed"},
				{ID: "ms-mol.8", Title: "Submit MR", Status: "open"},
				{ID: "ms-mol.9", Title: "Wait for verdict", Status: "open"},
				{ID: "ms-mol.10", Title: "Self-clean", Status: "open"},
			},
			wantErr: false,
		},
		{
			...
			children: []*beads.Issue{
				...
				{ID: "ms-mol.2", Title: "Set up branch", Status: "closed"},
				{ID: "ms-mol.3", Title: "Implement", Status: "closed"},
				{ID: "ms-mol.4", Title: "Self-review", Status: "open"},
				{ID: "ms-mol.5", Title: "Build check", Status: "closed"},
				{ID: "ms-mol.6", Title: "Commit changes", Status: "closed"},
				{ID: "ms-mol.7", Title: "Rebase verify", Status: "closed"},
				{ID: "ms-mol.8", Title: "Submit MR", Status: "open"},
			...
			wantErr:   true,
			wantInErr: []string{"ms-mol.4", "Self-review", "--skip-deps"},
		},
		{
			name: "multiple incomplete steps",
			children: []*beads.Issue{
				{ID: "ms-mol.1", Title: "Load context", Status: "closed"},
				{ID: "ms-mol.2", Title: "Set up branch", Status: "open"},
				{ID: "ms-mol.3", Title: "Implement", Status: "in_progress"},
				{ID: "ms-mol.4", Title: "Self-review", Status: "open"},
				{ID: "ms-mol.5", Title: "Submit MR", Status: "open"},
			},
			wantErr:   true,
			wantInErr: []string{"ms-mol.2", "ms-mol.3", "ms-mol.4"},
		},
		{
			name: "no submit step found — checks all steps",
			children: []*beads.Issue{
				{ID: "ms-mol.1", Title: "Load context", Status: "closed"},
				{ID: "ms-mol.2", Title: "Implement", Status: "open"},
				{ID: "ms-mol.3", Title: "Build check", Status: "open"},
			},
			wantErr:   true,
			wantInErr: []string{"ms-mol.2", "ms-mol.3"},
		},
		{
			name: "post-submit steps open is OK",
			children: []*beads.Issue{
				{ID: "ms-mol.1", Title: "Load context", Status: "closed"},
				{ID: "ms-mol.2", Title: "Submit MR", Status: "open"},
				{ID: "ms-mol.3", Title: "Wait for verdict", Status: "open"},
			},
			wantErr: false,
		},
		{
			...
			children: []*beads.Issue{
				{ID: "ms-mol.1", Title: "Implement", Status: "closed"},
				{ID: "ms-mol.2", Title: "SUBMIT MR and enter awaiting_verdict", Status: "open"},
				{ID: "ms-mol.3", Title: "Self-clean", Status: "open"},
			},
			wantErr: false,
		},
	}
