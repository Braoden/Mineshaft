...
var versionChanges = []VersionChange{
	...
	},
	{
		...
		Changes: []string{
			...
			"NEW: Persistent miners — identity survives across work assignments, gt done transitions to idle",
	...
	},
	{
		...
		Date:    "2026-02-23",
		Changes: []string{
			"NEW: Work queue dispatch engine — gt queue, gt queue epic, gt minecart queue, gt sling --queue",
			...
			"NEW: gt crew start --resume, gt crew at --reset, gt supervisor pending",
			...
			"CHANGED: Witness restart-first policy — miners are restarted instead of nuked (gt-dsgp)",
		},
	},
	{
		Version: "0.7.0",
		Date:    "2026-02-15",
		Changes: []string{
			"NEW: Minecart ownership — --owned flag, --merge strategy (direct/mr/local), gt minecart land",
			...
			"NEW: Overseer GT_ROLE Task tool guard",
	...
	},
	{
		...
		Date:    "2026-01-19",
		Changes: []string{
			"FIX: Orphan cleanup skips valid tmux sessions - Prevents false kills of witnesses/refineries/supervisor during startup by checking gt-*/hq-* session membership",
		},
	},
	{
		Version: "0.3.1",
	...
	},
	{
		...
		Changes: []string{
			...
			"NEW: gt minecart close - Manual minecart closure command",
	...
	},
	{
		...
		Changes: []string{
			...
			"NEW: gt minecart --tree and gt minecart check for cross-rig coordination",
	...
	},
	{
		...
		Changes: []string{
			...
			"NEW: Minecart system - gt minecart create/list/status",
