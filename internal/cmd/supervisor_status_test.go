...
func TestSupervisorStatusJSON_Schema(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("Marshal SupervisorStatusOutput: %v", err)
	}
...
// TestSupervisorStatusJSON_NoHeartbeat verifies heartbeat is omitted when nil.
func TestSupervisorStatusJSON_NoHeartbeat(t *testing.T) {
	out := SupervisorStatusOutput{
		Running:   false,
		Paused:    false,
		Session:   "ms-supervisor",
...
// TestSupervisorStatusJSON_Roundtrip verifies the struct can be marshaled and unmarshaled.
func TestSupervisorStatusJSON_Roundtrip(t *testing.T) {
	...
	var decoded SupervisorStatusOutput
...
// TestSupervisorStatusJSON_FreshnessStates verifies the three freshness states are mutually exclusive
// in typical usage (fresh, stale, very_stale).
func TestSupervisorStatusJSON_FreshnessStates(t *testing.T) {
	tests := []struct {
		name      string
		fresh     bool
		stale     bool
...
// TestSupervisorStatusJSON_LastActionOmitEmpty verifies last_action is omitted when empty.
