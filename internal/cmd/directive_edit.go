...
Examples:
  ms directive edit miner             # Edit rig-level miner directive
  ms directive edit crew --rig sky      # Edit sky rig crew directive
  ms directive edit witness --town      # Edit town-level witness directive`,
