...
// SessionHeartbeatStaleThreshold is the age at which a miner session heartbeat
...
// heartbeatsDir returns the directory for miner session heartbeat files.
...
// ReadSessionHeartbeat reads the heartbeat for a miner session.
