...
// ErrMinerNeedsRecovery marks an idle-looking miner that must not be reset
// or advertised as reusable until its preserved work is recovered or submitted.
var ErrMinerNeedsRecovery = errors.New("miner needs recovery before reuse")

// SlotReuseInput is the shared input for deciding whether a miner slot can be
...
// SlotReuseDecision explains whether a miner can be reused and why not.
