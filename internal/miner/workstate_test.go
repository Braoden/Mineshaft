...
func TestDecideWorkstateCanonicalFields(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			in:   WorkstateInput{State: StateIdle, CleanupStatus: CleanupClean, Branch: "miner/test", MQCheckRequired: true, HasSubmittableWork: true},
		...
		},
		{
			...
			in:   WorkstateInput{State: StateIdle, CleanupStatus: CleanupClean, Branch: "miner/test", MQCheckRequired: true, HasSubmittableWork: true, AssignedBeadTerminal: true},
