...
func TestRunTargetCleanHook_PerBead(t *testing.T) {
	...
	msg, err := RunTargetCleanHook(minerDir, clonePath, TargetCleanPolicy{Mode: TargetCleanModePerBead})
	if err != nil {
	...
	if readTargetCleanCounter(minerDir) != 1 {
		t.Errorf("counter should be 1, got %d", readTargetCleanCounter(minerDir))
	}
}
...
func TestRunTargetCleanHook_Never(t *testing.T) {
	...
	msg, err := RunTargetCleanHook(minerDir, clonePath, TargetCleanPolicy{Mode: TargetCleanModeNever})
	if err != nil {
		t.Fatalf("RunTargetCleanHook: %v", err)
	}
	if msg != "" {
	...
	if got := readTargetCleanCounter(minerDir); got != 0 {
...
func TestRunTargetCleanHook_EveryNBeads(t *testing.T) {
	...
	for i := 1; i <= 2; i++ {
		...
		if got := readTargetCleanCounter(minerDir); got != i {
	...
	if got := readTargetCleanCounter(minerDir); got != 3 {
	...
	if got := readTargetCleanCounter(minerDir); got != 4 {
...
func TestRunTargetCleanHook_MissingTargetIsNoop(t *testing.T) {
	...
	if got := readTargetCleanCounter(minerDir); got != 1 {
