...
func (c *HookAttachmentValidCheck) Run(ctx *CheckContext) *CheckResult {
	...
	return &CheckResult{
		...
		Details: details,
		FixHint: "Run 'ms doctor --fix' to detach invalid molecules, or 'ms mol detach <pinned-bead-id>' manually",
	}
}
...
func (c *HookSingletonCheck) Run(ctx *CheckContext) *CheckResult {
	...
	return &CheckResult{
		...
		Details: details,
		FixHint: "Run 'ms doctor --fix' to close duplicates, or 'bd close <id>' manually",
	}
}
...
func (c *OrphanedAttachmentsCheck) Run(ctx *CheckContext) *CheckResult {
	...
	return &CheckResult{
		...
		Details: details,
		FixHint: "Reassign with 'ms sling <id> <agent>', or close with 'bd close <id>'",
	}
}
...
//   - "mineshaft/nux" → miner at <townRoot>/mineshaft/miners/nux
//   - "mineshaft/crew/joe" → crew at <townRoot>/mineshaft/crew/joe
//   - "overseer" → overseer at <townRoot>/overseer
//   - "mineshaft-witness" → witness at <townRoot>/mineshaft/witness
//   - "mineshaft-refinery" → refinery at <townRoot>/mineshaft/refinery
