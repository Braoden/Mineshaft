...
// This enables idempotent `ms done` - if an MR already exists, we skip creation.
...
// newline in the needle prevents partial ID matches (e.g., "ms-abc"
// must not match "ms-abcdef").
